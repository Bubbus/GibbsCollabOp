...
SET_SQUAD_IMPORTANT(AWAL,true);
SET_SQUAD_COLOUR(AWAL,RED);

SET_SQUAD_IMPORTANT(BERTA,true);
SET_SQUAD_COLOUR(BERTA,BLUE);

SET_SQUAD_IMPORTANT(CESAR,true);
SET_SQUAD_COLOUR(CESAR,GREEN);

SET_SQUAD_IMPORTANT(DELTA,true);
SET_SQUAD_COLOUR(DELTA,MAGENTA);
